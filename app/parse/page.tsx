...
import Header from "../../components/parse/header";
  ...
  return (
    <>
      ...
      <div className="h-full w-full overflow-hidden">
        <div className="grid md:grid-cols-6 pb-10">
          ...
          <div className="flex px-6 text-gray-900 h-screen md:col-span-3 md-h-[calc(100vh-var(--top-nav-bar-height))] md:overflow-y-scroll">
