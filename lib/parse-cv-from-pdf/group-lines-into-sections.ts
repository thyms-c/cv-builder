import { CvKey } from "../redux/types"
import { CvSectionToLines, Line, Lines, TextItem } from "./types"

export const PROFILE_SECTION: CvKey = "profile"
