import { WorkExperience } from "../../redux/types"
import { isBold } from "../group-lines-into-sections"
import { CvSectionToLines, FeatureSet, TextItem } from "../types"
...
export const extractWorkExperience = (sections: CvSectionToLines) => {
